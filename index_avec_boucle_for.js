...
// Filtre en barre de recherche avec une boucle For plutôt que le filter
...
function filterData() {
    ...
    let cv = document.getElementById("Form_Search").value;
    ...
    for (let i = 0; i < dataArray.length; i++) {
        ...
        if (
            ...
            el.ingredients.some(ingredient =>
                ingredient.ingredient.toLowerCase().replace(/\s/g, "").includes(searchedString)
            ) ||
